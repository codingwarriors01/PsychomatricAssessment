                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <Link to="/demo" state={{ from: 'Aptitude' }} class="btn btn-info">Take a Tour Test</Link>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <Link to="/demo" state={{ from: 'VerbalQuestionpaper' }} class="btn btn-info">Take a Tour Test</Link>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="row g-0">
                    ...
                    <div class="col-md-8">
                      <div class="card-body">
                        ...
                        <Link to="/assist" state={{ from: 'AIAssist' }} class="btn btn-info">Go to Assistant</Link>
                      </div>
                    </div>
                  </div>
                </div>
